...
@section('title', 'Add New Benefit')
@section('page-title', 'Add New Benefit')
    ...
    <div class="card-body">
        <form action="{{ route('admin.benefits.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="icon" id="icon" value="{{ old('icon', 'fas fa-star') }}" required>
                
                <div style="margin-bottom: 10px;">
                    <strong>Selected Icon:</strong> 
                    <i id="selected-icon" class="fas fa-star" style="font-size: 32px; color: var(--primary-color); margin-left: 10px;"></i>
                    <span id="selected-icon-name" style="margin-left: 10px; color: #666;">fas fa-star</span>
                </div>
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-success">
                    <i class="fas fa-save"></i> Create Benefit
                </button>

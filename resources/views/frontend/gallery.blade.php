...
<head>
    ...
    <title>Photo Gallery - {{ \App\Models\SiteSetting::getSiteName() }}</title>
...
<body>
    ...
    <nav>
        <div class="container">
            ...
            <ul id="navMenu">
                ...
                <li><a href="{{ route('gallery') }}" style="color: #F5E6D3;">Gallery</a></li>
    ...
    <div class="page-header">
        <div class="container">
            <h1><i class="fas fa-images me-3"></i>{{ $contents['gallery_hero']->content ?? 'Photo Gallery' }}</h1>
            <p>{{ $contents['gallery_subtitle']->content ?? 'Explore our collection of memorable moments' }}</p>
        </div>
    </div>
            ...
            <div class="gallery-grid">
                @foreach($images as $image)
                    <div class="gallery-item">
                        <a href="{{ $image->image_url }}" class="glightbox" data-gallery="gallery" 

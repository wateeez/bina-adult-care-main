...
<body>
    ...
    <section class="about-hero" <?php if(isset($contents['about_hero']) && $contents['about_hero']->background_image): ?> style="background-image: linear-gradient(rgba(74, 144, 226, 0.1), rgba(74, 144, 226, 0.1)), url('<?php echo e(asset('storage/' . $contents['about_hero']->background_image)); ?>'); background-size: cover; background-position: center;" <?php endif; ?>>
        <div class="hero-content">
            <h1><?php echo e($contents['about_hero']->content ?? 'We Understand Caregiving — Because We\'ve Lived It.'); ?></h1>
        </div>
    </section>
    ...
    <div class="about-content">
        <div class="container">
            <div class="about-section">
                <h2><?php echo e($contents['about_story_title']->content ?? 'Our Story'); ?></h2>
                <p><?php echo e($contents['about_story']->content ?? 'As an organization founded and operated by individuals who have walked in your shoes, we intimately comprehend the intricate demands and emotional toll that caregiving can encompass. Our mission is to support, empower, and uplift caregivers with meaningful opportunities and compassionate understanding.'); ?></p>
            </div>

            <div class="about-section">
                <h2><?php echo e($contents['about_mission_title']->content ?? 'Our Mission'); ?></h2>
                <p><?php echo e($contents['about_mission']->content ?? 'To provide exceptional care services while creating meaningful career opportunities for passionate caregivers, fostering a community where both care recipients and caregivers thrive.'); ?></p>
            </div>

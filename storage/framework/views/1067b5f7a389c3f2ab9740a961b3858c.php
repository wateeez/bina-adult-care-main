...
<head>
    ...
    <title>Blog - <?php echo e(\App\Models\SiteSetting::getSiteName()); ?></title>
    ...
    <nav>
        <div class="container">
            ...
            <ul id="navMenu">
                ...
                <li><a href="<?php echo e(route('blog.index')); ?>" style="color: #F5E6D3;">Blog</a></li>
                        ...
                        <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <article class="blog-card">
                                <?php if($blog->header_image): ?>
                                    <img src="<?php echo e($blog->header_image_url); ?>" alt="<?php echo e($blog->title); ?>" class="blog-card-image">
                                <?php else: ?>
                                ...
                                <div class="blog-card-content">
                                    ...
                                    <p class="blog-card-excerpt"><?php echo e($blog->excerpt ?? Str::limit(strip_tags($blog->content), 150)); ?></p>
                                    <div class="blog-card-footer">
                                        <a href="<?php echo e($blog->url); ?>" class="read-more">
                                            Read More <i class="fas fa-arrow-right ms-1"></i>
                                        </a>
                                        <span style="color: #999; font-size: 0.85rem;">
                                            <i class="fas fa-eye"></i> <?php echo e($blog->view_count); ?> views
                                        </span>
                                    </div>
                                </div>
                            </article>
                    ...
                    <div class="sidebar">
                        ...
                        <?php $__currentLoopData = $latestBlogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $latest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="sidebar-post">
                                <?php if($latest->header_image): ?>
                                    <img src="<?php echo e($latest->header_image_url); ?>" alt="<?php echo e($latest->title); ?>">
                                <?php else: ?>
                                ...
                                <div class="sidebar-post-content">
                                    <h4><a href="<?php echo e($latest->url); ?>"><?php echo e(Str::limit($latest->title, 50)); ?></a></h4>
                                    <div class="sidebar-post-date"><?php echo e($latest->published_date); ?></div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
<?php /**PATH C:\Users\DELL\Desktop\My Files\Dev\bina-adult-care-main-master\resources\views/frontend/blog/index.blade.php ENDPATH**/ ?>